...
<html>
<head>
  <title>Surat Keluar Intern</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <!-- Content -->
  <div class="content">
<h3>Arsip Surat Keluar Intern</h3>
<div class="d-flex justify-content-between align-items-center mb-3">

      <!-- Tombol Tambah -->
      <a href="proses_tambah.php?type=keluar_in" class="btn btn-primary">
...
<form method="GET" 
  ...
  <a href="surat_keluar_in.php" class="btn btn-outline-secondary">Tampilkan Semua</a>
</form>
</div>
...
<table class="table table-bordered table-striped align-middle">
  ...
  <tr>
    ...
    <?php endif; ?>
    <td class="text-nowrap">
        <a href="proses_edit_surat.php?type=keluar_in&id=<?= $r['id'] ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  hapusModal.addEventListener('show.bs.modal', function (event) {
    ...
    link.href = "proses_hapus.php?type=keluar_in&id=" + id;
  });
});
</script>
</body>
