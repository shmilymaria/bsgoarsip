...
<html>
<head>
  <title>Surat Masuk Intern</title>
...
<div class="d-flex">
  ...
  <!-- Content -->
  <div class="content">
    <h3>Arsip Surat Masuk Intern</h3>
    <div class="d-flex justify-content-between align-items-center mb-3">

      <!-- Tombol Tambah -->
      <a href="proses_tambah.php?type=masuk_in" class="btn btn-primary">
      ...
      <form method="GET" 
        ...
        <a href="surat_masuk_in.php" class="btn btn-outline-secondary">Tampilkan Semua</a>
      </form>
    </div>
    ...
    <table class="table table-bordered table-striped align-middle">
      ...
      <tr>
        ...
        <?php if($_SESSION['role'] == 'admin'): ?>
        <td class="text-nowrap">
          <?= $r['username'] ? htmlspecialchars($r['username']) : '<span class="text-muted fst-italic">Tidak diketahui</span>' ?>
        </td>
        <?php endif; ?>
        <td class="text-nowrap">
          <a href="proses_edit_surat.php?type=masuk_in&id=<?= $r['id'] ?>" 
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      hapusModal.addEventListener('show.bs.modal', function (event) {
        ...
        link.href = "proses_hapus.php?type=masuk_in&id=" + id;
      });
    });
    </script>
  </div>
